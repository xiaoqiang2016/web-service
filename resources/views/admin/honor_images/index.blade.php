...
@section('title', 'Honor Certificates')
...
@section('content')
    <div class="bg-white rounded-lg shadow p-6 overflow-x-hidden">
        <h3 class="text-lg font-semibold text-primary mb-6">Honor Certificates Management</h3>
        
        <!-- Add New Image Form -->
        <div class="mb-8 p-4 bg-gray-50 rounded-lg">
            <h4 class="font-semibold mb-4">Add New Certificate</h4>
            <form action="{{ route('admin.honor-images.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-wrap gap-4 items-end">
                @csrf
            ...
            @forelse($images as $image)
                <div class="border rounded-lg overflow-hidden bg-gray-100" style="height: 170px;">
                    ...
                    <div class="p-1.5 bg-gray-50" style="height: 60px;">
                        ...
                        <form action="{{ route('admin.honor-images.destroy', $image) }}" method="POST" class="inline mt-1">
                            @csrf
                            @method('DELETE')
