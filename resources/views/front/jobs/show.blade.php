...
$jobTranslation = $job->translations->firstWhere('locale', $currentLocale) ?? $job->translations->first();
@endphp
@section('title', $jobTranslation?->seo_title ?: get_translated($job, 'title'))
@section('meta_description', $jobTranslation?->seo_description ?: get_translated($job, 'description') ?: 'Job details')
@section('meta_keywords', $jobTranslation?->seo_keywords ?: 'job, career')
    ...
    <div class="wp">
        ...
        <div class="header-right">
            <div class="header-lang">
                ...
                <ul>
                    <li><a href="{{ route('front.job.show', ['zh', $job->translation?->slug]) }}" rel="nofollow"><img src="{{ asset('index_files/en.png') }}">中文</a></li>
                    <li><a href="{{ route('front.job.show', ['en', $job->translation?->slug]) }}" rel="nofollow"><img src="{{ asset('index_files/en.png') }}">EN</a></li>
                    <li><a href="{{ route('front.job.show', ['vn', $job->translation?->slug]) }}" rel="nofollow"><img src="{{ asset('index_files/en.png') }}">VN</a></li>
                </ul>
            </div>
        </div>
...
<div class="path">
    <div class="wp cl">
        <p>You are here : <i class="qico qico-home"></i><a href="{{ route('front.index', app()->getLocale()) }}">Home</a> &gt; <a href="{{ route('front.jobs', app()->getLocale()) }}">Jobs</a> &gt; {{ get_translated($job, 'title') }}</p>
    </div>
</div>
...
<div class="main wp">
    ...
    <div class="job-detail">
        <h3>{{ get_translated($job, 'title') }}</h3>
        <div class="info">
            @if($job->department)
        ...
        <div class="job-section">
            ...
            {!! get_translated($job, 'description') !!}
        </div>
        <div class="job-section">
            <h4>Requirements</h4>
            {!! get_translated($job, 'requirements') !!}
        </div>
    </div>
