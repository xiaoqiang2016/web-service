...
@endphp
@section('title', $categoryTranslation?->seo_title ?: 'FAQ')
@section('meta_description', $categoryTranslation?->seo_description ?: 'Frequently asked questions')
@section('meta_keywords', $categoryTranslation?->seo_keywords ?: 'faq, questions')
